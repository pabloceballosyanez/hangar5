...
const items = [
  ...
  { name: "Glamping Familiar", slug: "glamping-familiar", type: "glamping", description: "Espacio ideal para familias. Conexión total con la naturaleza sin renunciar a la comodidad. Dos camas matrimoniales bajo un cielo estrellado.", price: 130000, capacity: "4 huéspedes · 2 camas matrimoniales", image: "/img/items/glamping-familiar/01.png", featured: false },
  { name: "Glamping Individual", slug: "glamping-individual", type: "glamping", description: "Perfecto para una escapada en solitario o en pareja. Un refugio minimalista entre los árboles.", price: 90000, capacity: "2 huéspedes · 1 cama Queen", image: "/img/items/glamping-individual/01.png", featured: false },
